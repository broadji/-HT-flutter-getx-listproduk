...
import 'id_ID/ar_ar_translation.dart';
...
class LocalizationService extends Translations {
  ...
  static Map<String,TextStyle> supportedLanguagesFontsFamilies = {
    ...
    'id': const TextStyle(fontFamily: 'Cairo'),
  };
  ...
  static bool isItEnglish() =>
      Prefs.getCurrentLocal().languageCode.toLowerCase().contains('en');

  /// get current locale
  static Locale getCurrentLocal () => Prefs.getCurrentLocal();
}
