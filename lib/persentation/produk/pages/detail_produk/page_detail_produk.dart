...
class _DetailProdukPageState extends State<DetailProdukPage> {
                ...
                onPressed: () {
                  AlertCostume.alertDialogConfirmation(
                      ...
                      "Data yang direfresh akan kembali kebentuk awal",
                          () {
                        Navigator.pop(context);
                        produkController.apiCallStatus.value =
                    ...
                    children: [
                      Container(
                          ...
                          child:
                            ...
                            children: [_listDetailProduk[0]["image"].contains(
                                "http") ?
                            CachedNetworkImage(
                                ...
                                imageUrl: widget.onUpdate == true
                                    ? _listDetailProduk[0]["image"]
                                    : produkController
                                    .data[widget.index].description
                                    .toString()) :
                            Image.file(
                                fit: BoxFit.fill,
                                File(_listDetailProduk[0]["image"])),
                              Obx(()=>
                              produkController.editFormProduk.value
                                  ?  Material(
                                  ...
                                  child: InkWell(
                                      ...
                                      child: Center(
                                          child: Icon(Icons.camera_alt)))):Container()),
                            ],
                          )),
                      SizedBox(
                        height: 20,
                      ...
                      dataForm(
                          ...
                          dataForm: widget.onUpdate == true
                              ...
                              .toString()
                              : _listDetailProduk[0]["title"].toString()),
                      dataForm(
                          typeVar: "String",
                          context: context,
                          title: "Category",
                          dataForm: widget.onUpdate == true
                              ...
                              .toString()
                              : _listDetailProduk[0]["category"].toString()),
                      dataForm(
                          typeVar: "double",
                          context: context,
                          title: "Price",
                          dataForm: widget.onUpdate == true
                              ? "\$ ${produkController.data[widget.index].price
                              .toString()}"
                      ...
                      dataForm(
                          ...
                          dataForm: widget.onUpdate == true
                              ...
                              .toString()
                              : _listDetailProduk[0]["description"].toString()),
                      SizedBox(
                        height: 20,
                      ),
                      Obx(
                        ...
                        produkController.editFormProduk.value == true ||
                            ...
                            true,
                            widget.onUpdate == true ? 'Update' : "Buat",
                            false,
                            null, () {
                          AlertCostume.alertDialogConfirmation(
                              context,
                              widget.onUpdate == true
                                  ? "Apakah anda ingin meng-update data?"
                            ...
                            produkController.apiCallStatus.value =
                                ApiCallStatus.loading;
                            if (widget.onUpdate == true) {
                              ApiProduk().loadUpdateDetailListProduk(
              ...
              child: CustomForm.inputForm(
                ...
                onChanged: (value) {
                  if (typeVar == "String") {
                    ...
                    _listDetailProduk[0][title.toLowerCase()] =
  ...
  //Async Get Image Upload Dokumen
  Future _getImage(ImageSource media) async {
    final pickerFile = await ImagePicker().pickImage(source: media);

    print('Original path: ${pickerFile!.path}');
    _listDetailProduk[0]["image"] = pickerFile.path;
